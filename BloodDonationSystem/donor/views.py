...
def make_request_view(request):
    bloodArray = [bmodels.Blood.OPositive.value, bmodels.Blood.ONegative.value, 
              bmodels.Blood.APositive.value, bmodels.Blood.ANegative.value, 
              bmodels.Blood.BPositive.value, bmodels.Blood.BNegative.value, 
              bmodels.Blood.ABPositive.value, bmodels.Blood.ABNegative.value]
    ...
    return render(request,'donor/makerequest.html',{'request_form':request_form,'bloodArray':bloodArray})
